...
<div id="wrapper" class="">
    ...
    <section id="single-page" class="section corporate-moving" style="">
        <div class="row single-page-heading ">
            <div class="header-overlay  darkend" style="background-image:url('/images/pages/cities/miami.jpg') "></div>
            <div class="container">
            ...
            <div class="container"> <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Home page" href="https://goborntomove.com/" class="home"><span property="name">Home</span></a>
                ...
                <span property="itemListElement" typeof="ListItem">
                    <a property="item" typeof="WebPage" title="Miami Moving Company" href="https://goborntomove.com/movers-miami" class="post post-page current-item">
                        <span property="name">Miami Moving Company</span>
                    </a>
                                        ...
                                        <div class="vc_column-inner vc_custom_1498318207858">
                                            <div class="wpb_wrapper">
                                                <div class="wpb_text_column wpb_content_element ">
                                                    <div class="wpb_wrapper">
                                                        <p>
                                                           Experienced and reliable <strong>Miami Movers</strong> are ready to move you across United States.
                                                           Born to Move Miami Moving Company is <strong>Fully licensed and Insured</strong> to provide long distance and local
                                                           moving services.
                                                        </p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="menu-services-container">
                                            <ul id="menu-services" class="menu">
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2739
                                                    {{ Request::is('/miami-to-new-york-moving') ?"current-menu-item" : ""}} one-page-link">
                                                    <a href="/miami-to-new-york-moving">Miami to New York Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2740
                                                    {{ Request::is('/miami-to-philadelphia-moving') ?"current-menu-item" : ""}} one-page-link">
                                                    <a href="/miami-to-philadelphia-moving">Miami to Philadelphia Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2741
                                                    {{ Request::is('/miami-to-washington-dc-moving') ?"current-menu-item" : ""}} one-page-link">
                                                    <a href="/miami-to-washington-dc-moving">Miami to Washington DC Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482
                                                    {{ Request::is('/miami-to-nashville-moving') ?"current-menu-item" : ""}} one-page-link">
                                                    <a href="/miami-to-nashville-moving">Miami to Nashville Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482
                                                    {{ Request::is('/miami-to-atlanta-moving') ?"current-menu-item" : ""}} one-page-link">
                                                    <a href="/miami-to-atlanta-moving">Miami to Atlanta Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482
                                                    {{ Request::is('/miami-to-chicago-moving') ?"current-menu-item" : ""}} one-page-link">
                                                    <a href="/miami-to-chicago-moving">Miami to Chicago Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482 one-page-link
                                                    {{ Request::is('/miami-to-baltimore-moving') ?"active" : ""}}">
                                                    <a href="/miami-to-baltimore-moving">Miami to Baltimore Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482 one-page-link
                                                    {{ Request::is('/miami-to-kansas-city-moving') ?"active" : ""}}">
                                                    <a href="/miami-to-kansas-city-moving">Miami to Kansas City Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482 one-page-link
                                                    {{ Request::is('/miami-to-san-francisco-moving') ?"active" : ""}}">
                                                    <a href="/miami-to-san-francisco-moving">Miami to San Francisco Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482 one-page-link
                                                    {{ Request::is('/miami-to-los-angeles-moving') ?"active" : ""}}">
                                                    <a href="/miami-to-los-angeles-moving">Miami to Los Angeles Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482 one-page-link
                                                    {{ Request::is('/miami-to-seatlle-moving') ?"active" : ""}}">
                                                    <a href="/miami-to-seatlle-moving">Miami to Seattle Movers</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
