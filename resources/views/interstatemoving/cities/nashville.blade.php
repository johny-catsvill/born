...
<div id="wrapper" class="">
    ...
    <section id="single-page" class="section corporate-moving" style="">
        <div class="row single-page-heading ">
            <div class="header-overlay  darkend" style="background-image:url('/images/pages/cities/nashville.jpg') "></div>
            <div class="container">
            ...
            <div class="container"> <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Home page" href="https://goborntomove.com/" class="home"><span property="name">Home</span></a>
                ...
                <span property="itemListElement" typeof="ListItem">
                    <a property="item" typeof="WebPage" title="Nashville Moving Company" href="https://goborntomove.com/movers-nashville" class="post post-page current-item">
                        <span property="name">Nashville Moving Company</span>
                    </a>
                                        ...
                                        <div class="vc_column-inner vc_custom_1498318207858">
                                            <div class="wpb_wrapper">
                                                <div class="wpb_text_column wpb_content_element ">
                                                    <div class="wpb_wrapper">
                                                        <p>
                                                           Experienced and reliable <strong>Nashville Movers</strong> are ready to move you across United States.
                                                           Born to Move Nashville Moving Company is <strong>Fully licensed and Insured</strong> to provide long distance and local
                                                           moving services.
                                                        </p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="vc_column-inner ">
                                            <div class="wpb_wrapper">
                                                <div class="kd-calltoaction no_icon " style="background-color: #f7f7f7;">
                                                    <div class="container">
                                                        <div class="cta-text">
                                                            <h3>Nashville Moving Company</h3>
                                        ...
                                        <div class="menu-services-container">
                                            <ul id="menu-services" class="menu">
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2739
                                                    {{ Request::is('/nashville-to-new-york-moving') ?"current-menu-item" : ""}} one-page-link">
                                                    <a href="/nashville-to-new-york-moving">Nashville to New York Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2740
                                                    {{ Request::is('/nashville-to-philadelphia-moving') ?"current-menu-item" : ""}} one-page-link">
                                                    <a href="/nashville-to-philadelphia-moving">Nashville to Philadelphia Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2741
                                                    {{ Request::is('/nashville-to-washington-dc-moving') ?"current-menu-item" : ""}} one-page-link">
                                                    <a href="/nashville-to-washington-dc-moving">Nashville to Washington DC Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482
                                                    {{ Request::is('/nashville-to-atlanta-moving') ?"current-menu-item" : ""}} one-page-link">
                                                    <a href="/nashville-to-atlanta-moving">Nashville to Atlanta Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482
                                                    {{ Request::is('/nashville-to-miami-moving') ?"current-menu-item" : ""}} one-page-link">
                                                    <a href="/nashville-to-miami-moving">Nashville to Miami Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482
                                                    {{ Request::is('/nashville-to-chicago-moving') ?"current-menu-item" : ""}} one-page-link">
                                                    <a href="/nashville-to-chicago-moving">Nashville to Chicago Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482 one-page-link
                                                    {{ Request::is('/nashville-to-baltimore-movingg') ?"active" : ""}}">
                                                    <a href="/nashville-to-baltimore-moving">Nashville to Baltimore Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482 one-page-link
                                                    {{ Request::is('/nashville-to-kansas-ciity-moving') ?"active" : ""}}">
                                                    <a href="/nashville-to-kansas-ciity-moving">Nashville to Kansas City Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482 one-page-link
                                                    {{ Request::is('/nashville-to-san-francisco-moving') ?"active" : ""}}">
                                                    <a href="/nashville-to-san-francisco-moving">Nashville to San Francisco Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482 one-page-link
                                                    {{ Request::is('/nashville-to-los-angeles-moving') ?"active" : ""}}">
                                                    <a href="/nashville-to-los-angeles-moving">Nashville to Los Angeles Movers</a>
                                                </li>
                                                <li  class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482 one-page-link
                                                    {{ Request::is('/nashville-to-seattle-moving') ?"active" : ""}}">
                                                    <a href="/nashville-to-seattle-moving">Nashville to Seattle Movers</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
