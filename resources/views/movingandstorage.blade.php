...
<div id="wrapper" class="">
    ...
    <section id="single-page" class="section corporate-moving" style="">
        <div class="row single-page-heading ">
            <div class="header-overlay  darkend" style="background-image:url('/images/movandsto.jpg')"></div>
            <div class="container">
                <div style="color: #fff;" class="breadcrumbs" typeof="BreadcrumbList" vocab="https://schema.org/">
                    ...
                    </span><span class="fa fa-angle-right"></span><span property="itemListElement" typeof="ListItem"><span property="item" typeof="WebPage" title="Go to Services." class="post post-page"><span property="name">Moving & Storage</span></span>
                                ...
                                <div class="vc_row wpb_row vc_inner vc_row-fluid">
                                    <div class="wpb_column vc_column_container vc_col-sm-12">
                                        <div class="vc_column-inner vc_custom_1498318207858">
                                            <div class="wpb_wrapper">
                                                <h2 style="text-align: left" class="vc_custom_heading vc_custom_1498386870700">Moving & Storage Boston</h2>
                                                <div class="wpb_text_column wpb_content_element ">
                                                    <div class="wpb_wrapper">
                                                        <p>Recently the service of things storage has become incredibly popular. During moving, repairing an apartment or office, for a long business trip or renting an apartment - using the storage services will greatly simplify your life.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="vc_row wpb_row vc_inner vc_row-fluid vc_custom_1498396190746">
                                    <div>
                                        <div class="vc_column-inner vc_custom_1499437272363">
                                            <div class="wpb_wrapper">
                                                <h2 style="text-align: left" class="vc_custom_heading vc_custom_1498388172144">Boston moving and storage company</h2>
                                                <div class="wpb_text_column wpb_content_element ">
                                                    <div class="wpb_wrapper">
                                                        <p>
                                                          Company “Born to Move” is a professional in the field of storage and movement of property. We provide our customers with the possibility of long-term or temporary storage of things of any size and value in Boston. Responsible storage of furniture and personal belongings when moving is the convenient service for those who have a long business trip, renting an apartment, repairing office or apartment. We also provide students with the boston student storage for keeping their stuff during summer. We can pick up items in the apartment or dorm and deliver everything back at the end of the summer before classes start. Our warehouses are equipped with modern security systems, they maintain the optimum level of humidity and temperature. They are ideal for long-term placement of office equipment, archival documents, personal items, soft and cabinet furniture.
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="wpb_wrapper">
                                                    <h2 style="text-align: left" class="vc_custom_heading vc_custom_1498388172144">Storage Pricing</h2>
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="wpb_wrapper">
                                                <div class="kd-calltoaction icon_browser " style="border: 2px solid #ff515e">
                                                    <div class="container">
                                                        ...
                                                        <div class="cta-text">
                                                            <h3>Moving and Storage Boston</h3>
                                    ...
                                    <div class="widget widget_nav_menu">
                                        ...
                                        <div class="menu-services-container">
                                            <ul id="menu-services" class="menu">
                                              ...
                                              <li class="menu-item menu-item-type-post_type menu-item-object-page page-item-2482 current-menu-item one-page-link"><a href="/moving-and-storage">Moving & Storage</a></li>
