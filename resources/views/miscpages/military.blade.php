...
<div id="wrapper" class="">
    ...
    <section id="single-page" class="section corporate-moving" style="">
        <div class="row single-page-heading ">
            <div class="header-overlay parallax-overlay darkend" style="height: 350px !important;background-image:url('/images/misc/goverment.jpg')"></div>
            <div class="container">
                <div style="color: #fff;" class="breadcrumbs" typeof="BreadcrumbList" vocab="https://schema.org/">
                    ...
                    </span><span class="fa fa-angle-right"></span><span property="itemListElement" typeof="ListItem"><span property="item" typeof="WebPage" title="Military and Government moving"  class="post post-page"><span property="name">Military and Goverment Moving</span></span>
                                        ...
                                        <div class="vc_column-inner vc_custom_1498318207858">
                                            <div class="wpb_wrapper">
                                                <div class="wpb_text_column wpb_content_element ">
                                                    <div class="wpb_wrapper">
                                                        <p>
                                                            Our moving company specializes in the military relocation services along the Boston area and Massachusetts as well as to other states.
                                                            We fully understand that military moving can be different from regular local or long distance moving services.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="vc_column-inner vc_custom_1499437272363">
                                            <div class="wpb_wrapper">
                                                ...
                                                <div class="wpb_text_column wpb_content_element ">
                                                    <div class="wpb_wrapper">
                                                        <p>
                                                            As you serve our country Born to Move movers serving our community. We are happy and proud to serve all military members and personal and their families.  Military relocation Will always be the part nowadays military life. If you moving into Hanscom Air Force Base in
                                                            Massachusetts or out of state from the military base. Our movers will always be glad to help you with your moving needs.
                                                            If you are taken into consideration moving out of state Born to move will be your first choice of the movers because the owner Born to move is a member of the US Army. That’s why we will offer a unique discount for military personnel when you are moving with our company. We are familiar with Hanscom Air Force Base and all the requirements that they ask for at the gate as military police can be strict for any commercial services that coming into the base. Our moving company offers is the exact size of the truck and moving solutions as you need for your new home. Often military relocation can be stressful because all the moving companies can delay your delivery but with Born to move movers this is never happening in your life because we have a next day delivery in other states across the country. If you’re being station and away from Hanscom Air Force Base we will help you to pack unpack all your belongings put them into the boxes and unload them at the new place where you want to see all your items.
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="wpb_text_column wpb_content_element ">
                                            ...
                                            <div class="wpb_wrapper">
                                                <div class="kd-calltoaction icon_browser " style="border: 2px solid #ff515e">
                                                    <div class="container">
                                                        ...
                                                        <div class="cta-text">
                                                            <h3>Boston Military and Government Movers</h3>
